...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2025 at 02:55 PM
...
(6, 23, 'uploads/foto_resep/677515cee8cb8.jpeg');
...
(1, 7, 1, 'Panaskan minyak goreng dalam wajan atau penggorengan.'),
(2, 7, 2, 'Tumis bawang putih dan bawang merah hingga harum.'),
(3, 7, 3, 'Masukkan daging ayam atau udang dan sayuran. Tumis hingga daging matang dan sayuran layu.'),
(4, 7, 4, 'Masukkan nasi putih yang sudah dimasak. Aduk hingga tercampur rata.'),
(5, 7, 5, 'Tambahkan kecap manis, kecap asin, dan merica. Aduk kembali hingga bumbu meresap.'),
(6, 7, 6, 'Masak selama 2-3 menit atau hingga nasi goreng matang dan kering.'),
(7, 7, 7, 'Angkat dari wajan dan taburi dengan daun bawang.'),
(8, 8, 1, 'Panaskan air di panci hingga mendidih.'),
(9, 8, 2, 'Masukkan serai, daun jeruk, dan lengkuas ke dalam air mendidih.'),
(10, 8, 3, 'Tambahkan pasta tom yum, cabai, dan udang. Masak hingga udang matang.'),
(11, 8, 4, 'Masukkan jamur dan tomat, lalu biarkan mendidih selama 5 menit.'),
(12, 8, 5, 'Tambahkan air jeruk nipis, kecap ikan, dan gula. Aduk rata, lalu sajikan.'),
(13, 9, 1, 'Rebus mi hingga matang, lalu tiriskan.'),
(14, 9, 2, 'Panaskan minyak di wajan, tumis bawang putih hingga harum.'),
(15, 9, 3, 'Masukkan sayuran dan tumis hingga layu.'),
(16, 9, 4, 'Tambahkan mi, kecap manis, dan bumbu mi instan. Aduk hingga rata.'),
(17, 9, 5, 'Masak hingga mi matang sempurna, lalu sajikan.'),
...
INSERT INTO `resep` (`ResepID`, `NamaResep`, `DeskripsiResep`, `LinkVideoTutorial`, `TotalHarga`) VALUES
(7, 'Nasi Goreng', 'Nasi goreng sederhana dengan bumbu khas', 'https://youtu.be/Js9FXCkn798', 0.00),
(8, 'Tom Yum', 'Sup pedas asam khas Thailand dengan udang dan jamur', 'https://youtu.be/2pRj9TiGldY', 0.00),
(9, 'Mi Goreng', 'Mi goreng dengan bumbu kecap manis dan sayuran', 'https://youtu.be/oyTI-M-FrzQ', 0.00),
(10, 'Corn Dog', 'Hot dog yang dibalut adonan tepung jagung dan digoreng', 'https://youtu.be/AfKPJhgrbYY', 0.00),
(11, 'Ayam Gulai', 'Ayam dimasak dengan bumbu gulai yang kental dan pedas', 'https://youtu.be/Z5kH8jAfNe0', 0.00),
(12, 'a', 'a', 'https://getbootstrap.com/docs/5.0/utilities/background/', 0.00),
(23, 'mi', 'sss', 'https://youtu.be/6sdlhjRE2u0?si=010VYwO0Ct0Bei8O', 0.00);
...
--
ALTER TABLE `langkahmemasak`
  MODIFY `LangkahID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `perkiraanharga`
  MODIFY `PerkiraanHargaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `resep`
  MODIFY `ResepID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `resepbahan`
--
ALTER TABLE `resepbahan`
  MODIFY `ResepBahanID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
